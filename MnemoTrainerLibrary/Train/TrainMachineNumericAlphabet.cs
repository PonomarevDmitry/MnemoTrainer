...
{
    public class TrainMachineNumericAlphabet
    {
        ...
        QuestionGeneratorNumericAlphabet generator = new QuestionGeneratorNumericAlphabet();
        ...
        public TrainTypeNumericAlphaget TestType
        {
        ...
        public TrainMachineNumericAlphabet()
        {
            timerHide = new Timer();
        ...
        private void CheckAnswer(bool autoTimer, string userAnswer)
        {
            ...
            currentSerie.Attempts.Add(new ExerciseAttempt(TrainType.NumericAlphabet, this.testStartDate, time, autoTimer, this.generator.QuestionText, this.generator.AnswerValue.ToString(), isAnswerRight, userAnswerText));
        ...
        {
            ExerciseTypeNumericAlphaget exerciseTypeDate = new ExerciseTypeNumericAlphaget();
