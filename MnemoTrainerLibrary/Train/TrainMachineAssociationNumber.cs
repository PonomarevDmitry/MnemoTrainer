...
{
    public class TrainMachineAssociationNumber
    {
        ...
        private QuestionGeneratorAssociationNumber generator = new QuestionGeneratorAssociationNumber();
        ...
        {
            get { return this.associationQuestions.Count; }
        }
        ...
        {
            int index = QuestionGeneratorAssociationNumber.SourceNets.IndexOf(net);
            if (index != -1)
            {
        ...
        {
            get { return this.generator.NumbersCount; }
            set
            {
                if (value <= 0)
                {
                ...
                bool changed = this.generator.NumbersCount != value;

                this.generator.NumbersCount = value;
                if (changed)
                {
                    this.settingsIsChanged();
                }
        ...
        public TrainMachineAssociationNumber()
        {
            ...
            {
                {
                    ...
                    if (nextQuestion != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(nextQuestion.NetName))
                        {
                            this.questionText += "\r\n" + nextQuestion.NetName;
                        }
                    }
                    else
                    {
        ...
        private void SaveExeruciseSerie()
        {
            ...
            ExerciseAttemptAssociationsNumber attempt = new ExerciseAttemptAssociationsNumber(testStartDate, testEndDate, testCheckDate, time, timeCheck);
            attempt.WithNumber = this.WithNumber;
            attempt.NumberCount = this.NumbersCount;
            ...
            ExerciseSerie currentSerie = new ExerciseSerie(new ExerciseType(TrainType.NumberAssociations));
        ...
        static TrainMachineAssociationNumber()
        {
            SourceNets = QuestionGeneratorAssociationNumber.SourceNets;
        }
    }
}
