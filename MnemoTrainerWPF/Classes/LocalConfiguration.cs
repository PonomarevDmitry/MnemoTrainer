...
namespace MnemoTrainer.Classes
{
    public static class LocalConfiguration
    {
        ...
        internal static void LoadControllerConfiguration(Window form, Controller saController)
        {
        ...
        internal static void SaveControllerConfiguration(Window form, Controller saController)
        {
        ...
        internal static void SaveControlCustomParameter(Window window, Control control, string paramName, string paramValue)
        {
            ...
            if (!string.IsNullOrEmpty(paramName) && control != null && !string.IsNullOrEmpty(control.Name))
            {
                ...
                if (window != null && !string.IsNullOrEmpty(window.Name))
                {
                    ...
                    {
                        // Создаем его, если его нет.
                        formNode = localParams.CreateElement(window.Name);
                        root.AppendChild(formNode);
                    }
        ...
        private const string xlmNodeNameVisible = "Visible";
                            ...
                            for (int i = 0; i < controls.Length; i++)
                            {
                                ...
                                if (!string.IsNullOrEmpty(control.Name))
                                {
                                    ...
                                    if (controlNode != null)
                                    {
                                        ...
                                        XmlNode controlVisible = controlNode[xlmNodeNameVisible];
                ...
                if (window != null && !string.IsNullOrEmpty(window.Name))
                {
                    ...
                    for (int i = 0; i < controls.Length; i++)
                    {
                        ...
                        if (!string.IsNullOrEmpty(control.Name))
                        {
                            ...
                            {
                                // Создаем его, если его нет.
                                controlVisible = localParams.CreateElement(xlmNodeNameVisible);
        ...
        internal static void LoadListCheckedItems(Window form, ListBox listBox)
        {
        ...
        internal static void SaveListCheckedItems(Window window, ListBox listBox)
        {
            // Если имя параметра, контрол и его имя не нулевые.
