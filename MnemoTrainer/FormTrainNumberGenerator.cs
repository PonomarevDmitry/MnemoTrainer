...
{
    public partial class FormTrainNumberGenerator : Form
    {
        ...
        void SaveFormConfiguration(object sender, FormClosedEventArgs e)
        {
            ...
            LocalConfiguration.SaveControlCustomParameter(chBAutoShow, "Checked", chBAutoShow.Checked ? "1" : "0");
        ...
        {
            train.IsAutoShowing = chBAutoShow.Checked;
            tBTestWord.Select();
        }
