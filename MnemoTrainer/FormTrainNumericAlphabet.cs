...
{
    public partial class FormTrainNumericAlphabet : Form
    {
        ...
        private void LoadFormConfiguration()
        {
            ...
            text = LocalConfiguration.LoadControlCustomParameter(cmBDictionary, "SelectedItem");
            if (!string.IsNullOrEmpty(text))
            {
                foreach (var item in cmBDictionary.Items)
                {
                    if (item.ToString() == text)
                    {
                        cmBDictionary.SelectedItem = item;
                        break;
                    }
                }
            }
        ...
        void SaveFormConfiguration(object sender, FormClosedEventArgs e)
        {
            ...
            {
                LocalConfiguration.SaveControlCustomParameter(cmBDictionary, "SelectedItem", cmBDictionary.SelectedItem.ToString());
            }
        ...
        private void FillWordCount()
        {
            ...
            if (cmBDictionary.SelectedItem != null)
            {
                FileInfo file = (FileInfo)cmBDictionary.SelectedItem;
            ...
            train.SelectedFile = cmBDictionary.SelectedItem as FileInfo;
        }
